...
public class OffresFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
       ...
       // ArrayList<Product> products = Controller.getAllProducts(markets.get(2).getMarketId());
        ...
        RecycleViewMarketsAdapter adapter = new RecycleViewMarketsAdapter(markets, getContext());
    ...
    public void onPause() {
        super.onPause();
        marketIdArray.clear();
        marketLogoUrlArray.clear();
        marketNameArray.clear();
        marketNameArrayTwo.clear();
