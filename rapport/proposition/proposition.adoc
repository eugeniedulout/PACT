...
L'objectif de notre projet est de simplifier la tâche d'aller faire des courses, aussi bien en amont de celle-ci (constitution de liste de courses simplifiées et éventuellement collectives, présentation des promotions disponibles) que dans le magasin (aide au repérage et localisation des produits).  
