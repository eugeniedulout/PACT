...
L'équipe chargée de ce module est au coeur du projet puisqu'elle developpera l'application Andoid par laquelle l'utilisateur se repérera dans le magasin après avoir rentré sa liste de course. L'équipe devra développer les différentes pages de l'application (écran de chargement, écran où l'on choisit le magasin, écran où l'on fait sa liste de produit, carte du magasin, promotions, ... ). Nous avons fourni un première aperçu de l'application ci-dessous (storyboard). On peut ainsi voir que de nombreuses fonctionnalités devront être prises en comtpe et reliées au reste du projet. L'interface ne s'arrête pas à l'application android.
