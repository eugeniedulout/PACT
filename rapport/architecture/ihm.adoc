...
La page offre (en haut à droite) liste des différentes promotions dans les magasins déjà utilisés par le client et les affiche par catégories. 
